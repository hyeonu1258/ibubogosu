/***
  ...
  이전 async 처리를 통한 callback 처리 시부터 msg에 담아 보낼시 그렇게 하면 안되는 경우고 발생하기에
  통일이 안되어 혼란스러울 수 있다. series 처리 시에는 데이터가 마지막에 배열로 콜백 되기에 msg에 담아 보낼 수 없고
  ...
  단, 에러 처리는 그때그때 필요한 에러 정보를 담기위해(ex. 출력된 데이터가 없는 경우) 발생하는 즉시 msg에 담아 보낸다.
***/
